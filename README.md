...
# Tutorial  men-Deploy Light Node (Celesita ITN The Blockspace Race) dalam bahasa Indonesia

<p style="font-size:14px" align="left">
<a href="https://medium.com/@icecreamalpha" target="_blank">Ikuti Medium saya untuk update seputar Celestia</a>
</p>
...
# Official Links
### [Dokumen Resmi Celestia](https://docs.celestia.org/nodes/blockspace-race/#phase-2-staging)
### [Discord Celestia](https://discord.gg/celestiacommunity)
...
# Save Mnemonic dan addressnya, lalu ambil faucet di discord Celestia dengan memakai command $request wallet kalian
...
# Ambil Node ID kalian untuk di submit di task yang tersedia
...
Pastekan Command Di atas berada di samping blockspacerace, lihat gambar di bawah
...
## Lalu Reload dan Restart atau nyalakan kembali Node kalian
...
# Delete Node ( Jika kalian menghapus node kalian tanpa sengaja dan membutuhkan bantuan Hubungi Testnet Support di Discord resmi Celestia )
```bash
systemctl stop celestia-lightd
